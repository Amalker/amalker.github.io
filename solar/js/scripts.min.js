...
$(function(){var n=($("#my-menu").mmenu({extensions:["theme-black","effect-menu-slide","pagedim-black","menu zoom","fx-menu-slide"],navbar:{title:'<img src="img/a.png" alt="Metal Solar">'},slidingSubmenus:!1,pageScroll:!0,offCanvas:{position:"right"},navbars:[{position:"bottom",content:["<a class='fa fa-instagram' href='#/'></a>","<a class='fa fa-facebook' href='#/'></a>"]}]}),$(".hamburger")),a=$("#my-menu").data("mmenu");n.on("click",function(){a.open()}),a.bind("open:finish",function(){setTimeout(function(){n.addClass("is-active")},100)}),a.bind("close:finish",function(){setTimeout(function(){n.removeClass("is-active")},100)})});