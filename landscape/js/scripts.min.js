...
$(function(){function e(){$(".contact .height-wrap").height("auto").equalHeights()}$(".toggle-mnu").click(function(){return $(this).toggleClass("on"),$(this).parent().next().next().find(" .main-menu").slideToggle(),!1}),$("footer .toggle-mnu").click(function(){return $("html, body").animate({scrollTop:$(document).height()+200},"slow"),!1}),$(window).resize(function(){e()});var a=$(".slider");a.owlCarousel({loop:!0,items:1,itemClass:"slide-wrap",nav:!0,navText:"",autoplay:!0,autoplaySpeed:3500,autoplayTimeout:5e3,autoplayHoverPause:!0,dotsSpeed:4e3,dragEndSpeed:2500}),$(".next").click(function(){a.trigger("next.owl.carousel",[1200])}),$(".prev").click(function(){a.trigger("prev.owl.carousel",[1200])}),$("#inline-popups").magnificPopup({delegate:"a",removalDelay:500,callbacks:{beforeOpen:function(){this.st.mainClass=this.st.el.attr("data-effect")}},midClick:!0}),$(".gallery-tizer-wrap").attr("href",$(".gallery-images a").attr("href")).css("background-image","url("+$(".gallery-images a").data("preview")+")"),$(".gallery-images a:first").remove(),$(".mfp-gallery").each(function(){$(this).magnificPopup({delegate:"a",mainClass:"mfp-zoom-in",type:"image",tLoading:"",gallery:{enabled:!0},removalDelay:300,callbacks:{beforeChange:function(){this.items[0].src=this.items[0].src+"?="+Math.random()},open:function(){$.magnificPopup.instance.next=function(){var e=this;e.wrap.removeClass("mfp-image-loaded"),setTimeout(function(){$.magnificPopup.proto.next.call(e)},120)},$.magnificPopup.instance.prev=function(){var e=this;e.wrap.removeClass("mfp-image-loaded"),setTimeout(function(){$.magnificPopup.proto.prev.call(e)},120)}},imageLoadComplete:function(){var e=this;setTimeout(function(){e.wrap.addClass("mfp-image-loaded")},16)}}})}),$("#price").magnificPopup({delegate:"li a",removalDelay:500,callbacks:{beforeOpen:function(){this.st.mainClass=this.st.el.attr("data-effect")}},midClick:!0}),$("a.hinge").magnificPopup({mainClass:"mfp-with-fade",removalDelay:1e3,callbacks:{beforeClose:function(){this.content.addClass("hinge")},close:function(){this.content.removeClass("hinge")}},midClick:!0}),$("a[href='#callback']").magnificPopup({mainClass:"mfp-zoom-in",removalDelay:300,type:"inline"}),$("a[href='#callback']").click(function(){var e=$(this).data("text");$(".form-mail h4").text(e)}),$(".main-menu li").click(function(){$(this).hasClass("active")||($(this).parents(".main-menu").find(".active").removeClass("active"),$(this).addClass("active"))}),$(".image-popup").magnificPopup({type:"image",closeOnContentClick:!0,closeBtnInside:!1,fixedContentPos:!0,mainClass:"mfp-no-margins mfp-with-zoom",image:{verticalFit:!0},zoom:{enabled:!0,duration:900}}),$("body").append('<div class="top"><i class="fa fa-angle-double-up">'),$("img, a").on("dragstart",function(e){e.preventDefault()}),$("body").on("click",".top",function(){$("html, body").animate({scrollTop:0},"slow")}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$("form").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"/mail.php",data:e.serialize()}).done(function(){e.find(".success").addClass("active"),setTimeout(function(){e.find(".success").removeClass("active"),e.trigger("reset"),$.magnificPopup.close()},3e3)}),!1}),$(".main-menu a").mPageScroll2id(),$(".icon-down").click(function(){$("html, body").animate({scrollTop:$(".about").offset().top},800)}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")})});